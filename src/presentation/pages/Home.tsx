        ...
        <div className="w-full max-w-lg rounded-lg p-4 pt-8">
          ...
          <ul className="">
            <li className="py-2 flex justify-between items-center w-220">
              <a
                href="#"
                className="flex justify-between block text-black hover:text-blue-600 bg-white hover:bg-gray-100 rounded-lg p-4 transition-colors duration-300 w-full"
              >
                <div>情報アーキテクチャ2 期末レポート</div>
